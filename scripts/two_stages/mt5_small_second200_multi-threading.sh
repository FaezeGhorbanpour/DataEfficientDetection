...
LANGUAGES=("es" 'pt' 'hi' 'ar' 'fr' 'it' 'de' 'tr' "en" "en" "en" "en" "en" "es" "en" "en")
RSS=(rs1 rs2 rs3 rs4 rs5)

MODEL_NAME="google/mt5-small"
FOLDER_NAME="mt5-small-second=200"
...
run_dataset() {
    ...
    for ((d=0; d<${#DATASETS[@]}; d++)); do
      ...
      for split in 2000; do
          for ((i=0; i<${#RSS[@]}; i++)); do
              FIRST_OUTPUT_DIR="${BASE}/results/mt5-small/first/${first_dataset}/${split}/${RSS[i]}/"
